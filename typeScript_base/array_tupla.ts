...
const palavras: string[] = ["string 0", "string 1", "string 2", "string 3"]
 ...
 * readonly
 */
const sóLeitura:readonly string[]= ["string 0", "string 1", "string 2", "string 3"];
 ...
 */
var arrTupla: [number, number, string]= [12,2,"string"]
